package com.app.githubmobile.ui.detail.datadisplay
...
import com.app.githubmobile.ui.detail.userfollow.UserFollowFragment
        ...
        when {
            ...
            when {
                cashCollapseState != null && cashCollapseState != this -> {
                    when (first) {
                        TO_EXPANDED -> {
                            /* set avatar on start position*/
                            isCollapsed = false
                            binding.detailAvatar.translationX = 0F
                            binding.detailAvatar.elevation = 0f
                        }
                        TO_COLLAPSED -> {
                            isCollapsed = true
                            binding.detailAvatar.elevation = 6f
                        }
                    }
